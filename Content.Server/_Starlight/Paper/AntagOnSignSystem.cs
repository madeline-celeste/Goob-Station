...
public sealed class AntagOnSignSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<AntagOnSignComponent, SignSuccessfulEvent>(OnPaperSigned);
    }

    private void OnPaperSigned(EntityUid uid, AntagOnSignComponent component, SignSuccessfulEvent args)
    {
        ...
        if (component.ParadoxClone)
        {
            ...
            paradoxCloneRuleComp.OriginalBody = args.User; // override the target player
